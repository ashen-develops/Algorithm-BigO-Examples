...
//---------------------CONSTANT TIME (O(1)) [[BEST]]------------------------
//No matter the size of your input, the algorithm will take
//the same amount of time to complete.

//Examples: Accessing an array item or performing basic arithmetic ops.
...
//Do take a bit longer with larger inputs, but just a little
//If an input of 10 takes 1 second then an input of 100 will take 2
...
//---------------------LINEAR TIME O(n)  [[MEH]]------------------------------
//Have running times that are directly proportional to the size (n) of the
//input

//Examples: summoning the elements in an array and finding the minimum or 
//maximum balue in an array.
...
//------------------POLYNOMIAL TIME O(n^k)  [[BIG OOF]]------------------------------
//Has an exponential running time
//Usualy consists of nested loops (an algorithim that requires two levels
//of looping O(n^2), one with 3 would be O(n^3), etc...)
...
//-------------------EXPONENTIAL TIME O(2^n) [[NO!]]-------------------------------
//An input with a size of 2 will take 2^2 times or 4, an input with a
//size of 10 will take 2^10 or 1024
